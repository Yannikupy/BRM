...
func (c *coreServiceClient) DeleteCompany(ctx context.Context, in *DeleteCompanyRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *coreServiceClient) DeleteEmployee(ctx context.Context, in *DeleteEmployeeRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *coreServiceClient) DeleteContact(ctx context.Context, in *DeleteContactRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (UnimplementedCoreServiceServer) DeleteCompany(context.Context, *DeleteCompanyRequest) (*empty.Empty, error) {
...
func (UnimplementedCoreServiceServer) DeleteEmployee(context.Context, *DeleteEmployeeRequest) (*empty.Empty, error) {
...
func (UnimplementedCoreServiceServer) DeleteContact(context.Context, *DeleteContactRequest) (*empty.Empty, error) {
